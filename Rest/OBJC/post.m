...
+(void) posthelloPostusername:(NSString *)username  andpass:(NSString *)pass andcool:(NSData *)cool andpic:(NSData *)pic andfileName:(NSString *)fileName andtheDict:(NSDictionary*)theDict andtheArray:(NSArray *)theArray withComp:(void (^)(BOOL, id))onCompletion{
	NSString * route = [NSString stringWithFormat:@"http://localhost:3000/helloPost/%@/%@",username,pass];
	NSDictionary * dict = 
		@{
			@"cool"                 : cool           ,
			@"pic"                  : pic            ,
